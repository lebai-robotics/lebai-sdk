# Check if SWIG is already available on the system
find_program(SYSTEM_SWIG_EXECUTABLE NAMES swig swig.exe)

if(SYSTEM_SWIG_EXECUTABLE)
  message(STATUS "Found system SWIG: ${SYSTEM_SWIG_EXECUTABLE}")
  set(SWIG_EXECUTABLE ${SYSTEM_SWIG_EXECUTABLE})
else()
  message(STATUS "System SWIG not found, downloading SWIG...")
  ...
  message(STATUS "Downloaded SWIG to: ${SWIG_EXECUTABLE}")
endif()

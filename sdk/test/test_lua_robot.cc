...
namespace lebai
{
  ...
  TEST_F(LuaRobotTest, SendOneCase)
  {
    ...
    EXPECT_NO_THROW(lua_robot_.send("movej({j1 = 0.0, j2 = 0, j3 = 0, j4 = 0, j5 = 0, j6 = 0}, 1.2, 0.2, 0, 0)"));
    EXPECT_NO_THROW(lua_robot_.send("movej({j1 = 1.0, j2 = 0, j3 = 0, j4 = 0, j5 = 0, j6 = 0}, 1.2, 0.2, 0, 0)"));
  }

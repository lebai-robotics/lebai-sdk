...
namespace lebai {
namespace led {
void LedData::set_mode(LedMode mode) { mode_ = mode; }
LedMode LedData::mode() const { return mode_; }
LedMode *LedData::mutable_mode() { return &mode_; }

// set_speed
void LedData::set_speed(LedSpeed speed) { speed_ = speed; }
LedSpeed LedData::speed() const { return speed_; }
LedSpeed *LedData::mutable_speed() { return &speed_; }
void LedData::set_colors(const std::vector<LedColor> &colors) {
  colors_ = colors;
}
const std::vector<LedColor> &LedData::colors() const { return colors_; }
std::vector<LedColor> *LedData::mutable_colors() { return &colors_; }
// Deserialize
...
bool LedData::IsNullJSONData() const { return false; }

void VoiceData::set_voice(VoiceKind voice) { voice_ = voice; }

VoiceKind VoiceData::voice() const { return voice_; }

VoiceKind *VoiceData::mutable_voice() { return &voice_; }

void VoiceData::set_volume(Volume volume) { volume_ = volume; }

Volume VoiceData::volume() const { return volume_; }

Volume *VoiceData::mutable_volume() { return &volume_; }
...
bool VoiceData::IsNullJSONData() const { return false; }

void FanData::set_fan(FanMode fan) { fan_ = fan; }
FanMode FanData::fan() const { return fan_; }
FanMode *FanData::mutable_fan() { return &fan_; }
...
bool FanData::IsNullJSONData() const { return false; }
}  // namespace led
}  // namespace lebai
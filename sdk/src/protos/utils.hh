...
namespace lebai {
/**
 * @brief Generate a json rpc request string from id, method and a json data as
 * params.
 *
 ...
 */
std::string ToJSONRpcReqString(int id, const std::string &method,
                               const JSONBase &data);
/**
 * @brief Generate a json rpc request string from id, method and a params
 * string.
 *
 * @param id The id of the request.
 * @param method The method name.
...
JSONRpcRespParseResult ExtractJSONRpcRespString(const std::string &s, int &id,
                                                int &error_code,
                                                std::string &data);
}  // namespace lebai
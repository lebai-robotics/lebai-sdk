...
namespace lebai
{
  namespace l_master
  {
    ...
    motion::MotionIndex Robot::RobotImpl::moveLinear(const motion::MoveRequest &req)
    {
      std::string resp;
    ...
    motion::MotionIndex Robot::RobotImpl::speedJoint(const motion::SpeedJRequest &req)
    {
      std::string resp;
    ...
    motion::GetMotionStateResponse Robot::RobotImpl::getMotionState(const motion::MotionIndex &req)
    {
      std::string resp;
    ...
    posture::CartesianPose Robot::RobotImpl::getPoseTrans(const posture::GetPoseTransRequest &req)
    {
      std::string resp_str;
    ...
    void Robot::RobotImpl::setSerialBaudRateRequest(const serial::SetSerialBaudRateRequest &req)
    {
      json_rpc_connector_->CallRpc("set_serial_baud_rate", req.ToJSONString(), nullptr);
    }
    void Robot::RobotImpl::setSerialParityRequest(const serial::SetSerialParityRequest &req)
    {
      json_rpc_connector_->CallRpc("set_serial_parity", req.ToJSONString(), nullptr);
    }
